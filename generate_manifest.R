...
required_pkgs <- c(  "AID", "callr", "calibrate", "cartography", "cluster", "data.table",
                     "datawizard", "devtools", "digest", "dplyr", "DT", "epiR", "FactoMineR",
                     "factoextra", "ffp", "forecast", "ggplot2", "ggpubr", "ggtext", "grid",
                     "gt", "imputeTS", "installr", "irr", "janitor", "kableExtra", "KernSmooth",
                     "knitr", "lattice", "lubridate", "MASS", "matrixStats", "mclust", "MethComp",
                     "mixR", "modeest", "moments", "multimode", "multiway", "nortest", "openxlsx",
                     "pandoc", "patchwork", "plotly", "prettydoc", "qqplotr", "readr", "readxl",
                     "refineR", "reflimR", "rmarkdown", "RVAideMemoire", "scales", "shiny",
                     "shinyjs", "shinythemes", "stats", "stringi", "systemfonts", "tidyr",
                     "tools", "univOutl", "utf8", "writexl", "xfun", "zlog")
