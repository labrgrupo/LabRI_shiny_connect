...
if (n_total_table2 > 2000) {
  resultados_table2 <- data.frame(resultados)[1:2000, , drop = FALSE]
...
if (nrow(dataset.escolhido) > 2000) {
  Fig.2
} else {
...
if (n_total_table24 > 2000) {
  
  tabela.Quali.html <- data.frame(tabela.Quali)[1:2000, , drop = FALSE]
