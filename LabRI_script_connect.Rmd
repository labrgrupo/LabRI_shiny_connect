...
plot_UL_IE <- ggplot() +
  ...
  geom_point(
    ...
    aes(
      x = Bias_LS,
      y = Limite_Referencia,
      color = paste(IC_IR_select2*100,"Confidence Interval of the URL")
    ),
    size = 6
  ) +
  geom_errorbarh(
  ...
  scale_color_manual(
    name = "Legend",
    values = c(paste(IC_IR_select2*100,"Confidence Interval of the URL") = "blue2")
  ) +
  labs(
    title = titulo.fig.25,
  ...
  ggplot() +
    ...
    geom_point(
      ...
      aes(
        x = Bias_LI,
        y = Limite_Referencia,
        color = paste(IC_IR_select2*100,"Confidence Interval of the LRL")
      ),
      size = 6
    ) +
    geom_errorbarh(
    ...
    scale_color_manual(
      name = "Legend",
      values = c(paste(IC_IR_select2*100,"Confidence Interval of the LRL") = "blue2")
    ) +
    labs(
